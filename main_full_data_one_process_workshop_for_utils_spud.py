...
def process_dataset(dataset_dir, model_ids, image_size, conf_threshold, correction, sat_factors, kernel_size, DO, t, vertical, ranges, process_types):
    ...
    for (process_type, sat_factor, model_id), metrics in global_metrics.items():
        save_metrics_to_txt(dataset_dir, image_size, conf_threshold, correction, sat_factor, kernel_size, DO, t, vertical, metrics, process_type, ranges, model_id)

    return global_metrics

def save_metrics_to_txt(dataset_dir, image_size, conf_threshold, correction, sat_factor, kernel_size, DO, t, vertical, metrics, process_type, ranges, model_id):
